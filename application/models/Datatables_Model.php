<?php 
 class Datatables_Model extends CI_Model {
    ...
    var $column_order_lead = array(null,'customer_name','id','company_name','state','city','mobile_no','assigned_by','assigned_to','created_date','userid','status','description','requirement'); 
    var $column_search_lead = array('customer_name','id','company_name','state','city','mobile_no','assigned_by','assigned_to','created_date','userid','status','description','requirement');  
