                    ...
                    <div class="row">
                      ...
                      <i class="fa fa-3x fa-users"></i>       
                        ...
                        <div class="col-md-9 col-xs-9 col-sm-9 custom-col-8">
                         ...
                         <a href="<?php echo site_url(); ?>employee"> <h4>Total Employee</h4>  </a>
                          </div>
                      </div>   
                </div>
              </div>
                     ...
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-bullhorn"></i>       
                         ...
                         <div class="col-md-9 col-xs-9 col-sm-9 custom-col-8">
                          ...
                          <a href="<?php echo site_url(); ?>create_lead">  <h4>Total Lead</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                  
                    ...
                    <div class="row">
                      ...
                      <i class="fa fa-3x fa-phone"></i>       
                        ...
                        <h2 class="mb-5"><?php if(!empty($leads[0]->contacted)){ echo $leads[0]->contacted; }else{ echo '0'; }?></h2>
                         <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Contacted"> <h4>Contacted Lead</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                  
                ...
                <div class="card-body">
                     ...
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-mobile"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Not Contacted">  <h4>Not Contacted Lead</h4></a>
                         </div>  
                     </div>
                ...
                <div class="card-body">
                     ...
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-random"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=E Relevant"> <h4>E-Relevant Lead</h4></a>
                         </div>  
                     </div>
              ...
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                      ...
                      <i class="fa fa-3x fa-plus"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Follow Up"><h4>Follow Up Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
                ...
                <div class="card-body">
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-dropbox"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Case Dropped"><h4>Case Dropped Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
                ...
                <div class="card-body">
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-unlink"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Lost Lead"><h4>Lost Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
                ...
                <div class="card-body">
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-inbox"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Importance"><h4>Importance Leads</h4></a>
                         </div>  
                     </div>
                ...
                <div class="card-body">
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-handshake-o"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Negotiation"><h4>Negotiation Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
              ...
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                      ...
                      <i class="fa fa-3x fa-weight-normal"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Deal Done"><h4>Deal Done Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
                ...
                <div class="card-body">
                     <div class="row">
                      ...
                      <i class="fa fa-3x fa-envelope-o"></i>       
                        ...
                        <a href="<?php echo site_url(); ?>detail_lead_details?lead_status=Quotation Sending"><h4>Quotation Sending Leads</h4></a>
                         </div>  
                     </div>
                <!-- <img src="<?php echo base_url(); ?>support_assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/> -->                                    
