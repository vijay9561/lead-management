...
<div id="commentpopup" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
  <form method="post" id="lead_submiting_forms"> 
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Submit Comment</h4>
      </div>
      ...
      <button type="submit" class="btn btn-primary" id="submit_button">Submit Comment</button> 
...
<div id="LeadComment" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Lead Comment Details</h4>
      </div>
      <div class="modal-body" id="lead_comment_details">  
